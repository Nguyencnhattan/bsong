...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
   	<!-- JQUERY -->
	<script src="<%=request.getContextPath() %>/resources/admin/assets/js/jquery-3.2.1.js"></script>
 	<!-- JVALIDATE -->
    <script src="<%=request.getContextPath() %>/resources/admin/assets/js/jquery.validate.min.js"></script>
    <!-- CKEDITOR -->
    <script src="<%=request.getContextPath() %>/resources/admin/assets/ckeditor/ckeditor.js"></script>
    <style type="text/css">
