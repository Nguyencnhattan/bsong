...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="">BSong <small>Nguyen Chau Nhat Tan</small></a></h1>
      </div>
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="<%=request.getContextPath()%>/publicIndexController"><span>Trang chủ</span></a>
          <li ><a href="<%=request.getContextPath()%>/publicContactController"><span>Liên hệ</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
